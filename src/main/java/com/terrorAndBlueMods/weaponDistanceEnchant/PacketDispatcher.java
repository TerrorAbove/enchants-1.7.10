...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(ExtraEnchantsMain.MODID);
	...
	public static final void registerPackets() {
		...
		registerMessage(PlayerAttackEntityMessage.Handler.class, PlayerAttackEntityMessage.class, Side.SERVER);
		registerMessage(PlayerMineBlockMessage.Handler.class, PlayerMineBlockMessage.class, Side.SERVER);
		
		registerMessage(UpdateBleedIconMessage.Handler.class, UpdateBleedIconMessage.class, Side.CLIENT);
